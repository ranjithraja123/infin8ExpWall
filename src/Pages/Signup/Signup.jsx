...
const Signup = () => {
    return (
        <div className="sign h-screen flex items-center justify-center bg-gradient-to-b from-black via-green-700 via-amber-500 to-yellow-400 bg-opacity-90">
            <div className="w-full max-w-md p-8 bg-white/30 backdrop-blur-md rounded-3xl shadow-lg">
                ...
                <form className="space-y-4">
                    ...
                    <div>
                        <p className="text-center text-white">Already have an account? <a href="/login">Click Here</a> </p>
                    </div>
                </form>
            </div>
        </div>
